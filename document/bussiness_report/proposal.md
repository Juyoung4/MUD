...
- 경쟁사와 today news의 차별점 

      뉴썸과 썸리는 사람이 직접 시사상식을 쉽게 해석해 높은 서비스로 재가공시간이 필요하기 땜누에 최근 주요 뉴스를 바로 받아볼 수 없다.
      투데이뉴스는 AI가 기사를 요약해주기 때문에 두 서비스보다는 훨씬 빠른시간 내 기사를 받아볼 수 있다.

       뉴스 10은 실시간10개 주요뉴스의 헤드라인을 보여준다.
       다양한 뉴스를 보기 힘들며 투데이 뉴스는 개인 추천 시스템을 도입하기 때문에 뉴스10보다 개인화기능에서는 우위에 있다 볼 수 있다.
...
**프리미엄 모델을 통한 뉴스 유료화**<br>
  ...
  (2)적용
    ...
    - 한달의 일정 금액을 지불하면 광고가 없는 모든 뉴스를 볼 수 있다
