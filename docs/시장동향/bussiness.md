...
경쟁사 특징|다른 뉴스들과 달리 '독자 중심의 접근방식'을 기준으로 뉴닉 창시|아침,점심,저녁 시간대 별 뉴스 업데이트와 AI가 뽑아주는 뉴스를 딱 10가지를 보여주고 또는 음성 브리핑 서비스 받을 수 있다| 썰리는 자신이 관심있는 카테고리를 지정한 후 나온 기사들 중 하나를 클릭하게 되면 '특정 주제'에 대해 가상의 두명 인물이 대화를 나누는듯 한 화면에 '특정 주제'에 대해 친절하게 설명해주는 방식이다
