...
class Writer(object):
    ...
    def initialize_file(self):
        ...
        if self.user_operating_system == "Windows":
            self.file = open('Article_' + self.category_name + '_' + self.date1 + '.csv', 'w', encoding='euc-kr',
                             newline='')
        # Other OS uses utf-8
        else:
            self.file = open('Article_' + self.category_name + '_' + self.date1 + '.csv', 'w', encoding='utf-8',
                             newline='')
        ...
        for URL in day_urls:
            ...
            for content_url in post:  # 기사 URL
                ...
                try:
                    ...
                    resultdata = [news_date, category_name, text_company, text_headline, text_sentence, content_url,
                                  text_date]
                    print(resultdata)
                    q.put(resultdata)
                    print("!")
